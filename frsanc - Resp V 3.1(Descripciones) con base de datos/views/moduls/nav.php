...
<?php if(isset($_GET["pag"])): ?>
	...
	<nav class="menu-lateral">
		...
		<a href="index.php?pag=logIn" <?php $verif -> selecNav("logIn"); ?>><i class="far fa-heart"></i>Inicio Sesión</a>
	</nav>
...
<?php else: ?>
	...
	<nav class="menu-lateral">
		...
		<a href="index.php?pag=logIn"><i class="far fa-heart"></i>Inicio Sesión</a>
	</nav>
